...
const int m1ndb = 28 , m1pdb = 28, m2ndb = 28 , m2pdb = 25; // note the values are always positive good for george
...
const int m2stby = 6, m2ain1 = 4, m2ain2 = 5, m2pwmpin = 9,  mpsfactor = 250, mpsfactor2 = 270;
...
void setup()  
{
  ...
  ////////////////           Set PID output limits       /////////////////////
    ...
    speedPID.SetOutputLimits(-0.22,0.22);
    speedPID.SetMode(AUTOMATIC);
    speedPID.SetSampleTime(speedpidsampletime);
  
    gyroyPID.SetOutputLimits(-65,65);
