...
############################################################
# Kalman Filter - based on code written by Kristian Lauszus, 
...
# Kalman filter based on code written by Kristian Lauszus, TKJ Electronics (2012).
