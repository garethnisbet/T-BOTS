...
pygame.init()
screen0 = pygame.display.set_mode((900, 640), 0, 0)
canvas = pygame.image.frombuffer(frame.tostring(),frame.shape[1::-1],'RGB')

x, y, x2, y2, starttime, endtime = [], [], [], [], [], []
textstr = ''
textstr2 = ''
...
#----------------------------------------------------------------------#
#               Sets the length of history trail
#----------------------------------------------------------------------#
...
#----------------------------------------------------------------------#
#               Setup controll loop parameters
#----------------------------------------------------------------------#
...
akd_o = 0.01
#----------------------------------------------------------------------#
#                 Make a copy for reset function
#----------------------------------------------------------------------#
...
if __name__ == '__main__':
    ...
    #     Pygame Screen Setup                                          
    #                                                                  
    #     Setup PyGame Keys  (Mouse and Keyboeard)                     
    #                                                                  
    #------------------------------------------------------------------#
    while drawplot:
    ...
    #                        Load Drawn Data                           
    #                                                                  
    #     Interpfactor less than one will sub sample waypoints         
    #                                                                  
    #------------------------------------------------------------------#
    ...
    if interpfactor > 1:
        ...
        datarange = list(range(0,aa.shape[0],step))+[aa.shape[0]-1]
        aa = aa[datarange,:]
