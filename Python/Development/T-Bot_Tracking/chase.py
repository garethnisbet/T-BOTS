...
if __name__ == '__main__':
    ...
    while cap.isOpened():
        ...
        try:
            x3, y3, center3, radius3, M3, cents3 = tracker(frame, yellowLower, yellowUpper)

            if radius3 > 1:
                cv2.circle(frame, (int(x3), int(y3)), int(radius3),(255,0,0), 2)
                cv2.circle(frame, center3, 2, (255,0,0), -1)
                pts3.appendleft(center3)
            
        except:
            x3,y3 = frame.shape[1]/2., frame.shape[0]/2.
            cv2.circle(frame, (int(x3), int(y3)), int(5),(255,0,0), 2)
            pts3.appendleft((x3,y3))
            pass
        ...
        if x != [] and x2 !=[] and x3 !=[]:
            ...
            _distance = distance((x,y),(x2,y2),(x3,y3))




            angle = turn((x,y),(x2,y2),(x3,y3))
            ...
            if iii > 50:
                data = sock.recv(132).decode(encoding='utf-8')
