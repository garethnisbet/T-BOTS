...
trackmarksArray = np.array([[0,origin[1]+wheel_radius],[1000,origin[1]+wheel_radius],[1000,origin[1]+wheel_radius+10],[0,origin[1]+wheel_radius+10],[0,origin[1]+wheel_radius]])
