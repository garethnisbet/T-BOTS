...
# Background images
bg = pygame.image.load(dirpath+'/Simple/SlateWallpaper.jpg').convert() 
...
while not done:
    ...
    pygame.gfxdraw.filled_polygon(screen, (tbot_tup), (255,102,0, 200))         
    pygame.gfxdraw.aapolygon(screen, (tbot_tup), (255,102,0, 255))
    pygame.gfxdraw.aapolygon(screen, (spokes_tup), BLACK)
    pygame.gfxdraw.aacircle(screen, origin[0], origin[1], wheel_radius-tyre, BLACK)
    pygame.gfxdraw.aacircle(screen, origin[0], origin[1], wheel_radius, BLACK)
