...
sldr_a = plt.Slider(ax_a, 'Rotation Rate', s1-1, s1+1,valinit=s1,valfmt = '%0.5f',color='gray')
sldr_b = plt.Slider(ax_b, 'Speed Factor', s2-1, s2+1,valinit=s2,valfmt = '%0.5f',color='gray')
