...
#
    ...
    if joystick.get_button(4) & joystick.get_button(1):
    ...
    elif joystick.get_button(4) & joystick.get_button(3):
    ...
    if joystick.get_button(6) & joystick.get_button(8):
        screen.blit(L1L2,posL)
    elif joystick.get_button(9) & joystick.get_button(7):
        screen.blit(R1R2,posR)
    elif joystick.get_button(6) & joystick.get_button(7):
        screen.blit(L1,posL)
        screen.blit(R1,posR)
    elif joystick.get_button(9) & joystick.get_button(6):
        screen.blit(L1,posL)
        screen.blit(R2,posR)
    elif joystick.get_button(7) & joystick.get_button(8):
        screen.blit(L2,posL)
        screen.blit(R1,posR)
    elif joystick.get_button(9) & joystick.get_button(8):
        screen.blit(L2,posL)
        screen.blit(R2,posR)
        
    if joystick.get_button(6) & joystick.get_button(7) & joystick.get_button(8):
        screen.blit(L1L2,posL)
        screen.blit(R1,posR)
    elif joystick.get_button(6) & joystick.get_button(8) & joystick.get_button(9):
        screen.blit(L1L2,posL)
        screen.blit(R2,posR)
    ...
    if joystick.get_button(9) & joystick.get_button(8) & joystick.get_button(6) & joystick.get_button(7):
        screen.blit(L1L2,posL)
        screen.blit(R1R2,posR)
